...
- **Story 0.7 (Last- & Performance-Tests mit E2E-Szenarien):** 🟡 Als Entwickler möchte ich reproduzierbare Last- und Performance-Tests mit realitätsnahen E2E-Szenarien haben, damit Engpässe in Live-Sessions, Join-Flows, Freitext, Q&A und Synchronisierung früh erkannt und vor Releases messbar bewertet werden können.
  ...
  - **Aktueller Implementierungsstand (2026-07-09, abgeglichen mit [ADR-0013](docs/architecture/decisions/0013-use-k6-and-artillery-for-load-and-performance-testing.md) und [CI-WORKFLOW.md](docs/CI-WORKFLOW.md)):**
    ...
    - **Abgedeckt (Hotpaths):** Join-Welle, aktive Frage, Vote-Spike, Status-Fan-out (WS), Host-Vote-Fortschritt, Timer-Fairness, Q&A-Einreichung, Blitzlicht-Tempo, Demo-Quiz (9 Fragen), Artillery-Live-Session bis 500 TN lokal, **Reconnect-Welle (30 TN, Classroom-Smoke)**.
    - **Akzeptanzkriterien — Erfüllungsgrad (Kurz):**
      ...
      - Szenarien Join/Quiz/Vote/Q&A-Einreichung/Blitzlicht/Reconnect (Classroom-30): **ja**; Freitext-Word-Cloud, Sync unter Last, Reconnect in Artillery/k6-Hochlast: **offen**.
    ...
    - **Offen für volle Story-Erfüllung:** Freitext-/Word-Cloud-Last, Q&A-Moderation unter Spitzenlast, Yjs-Sync-Last, Reconnect in Artillery-/k6-Hochlast, formalisierte Laststufen (klein/mittel/hoch), vereinheitlichte maschinenlesbare Summary mit Laufvergleich, k6-Threshold als optionales PR-Gate; produktionsnaher Voll-Lauf (Vote/Status auf Hetzner) noch nicht abgeschlossen.
